...
We have two data sets: all the games and all the games with castling. We know, that the unbiased estimator fot P is sample mean, so we can perform a t-test (as variance is unknown)
