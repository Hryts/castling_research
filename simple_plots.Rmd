...
#### Dependency of success of castling on number of move when it was made

We decided to also check if it is more sufficient to make castling earlier or later.
Here is the plot of victory rate after castling in dependence on move when it was made.
...
Here we can see that it is more profitable to castle later. We suppose, that it is a loss of tempo to castle early. In addition, the oponent can improve his attack on the side where the king is.
